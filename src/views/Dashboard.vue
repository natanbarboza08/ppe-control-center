<template>
  ...
  <div class="shell">
    ...
    <aside class="sidebar">
      ...
      <img class="logo" src="./assets/logoPCCPNG.png" alt="Software Logo" width="80">
      <h1 class="logoText">
        PPE Control Center
      </h1>
      ...
      <nav class="menu">
        ...
        <router-link to="/dashboard/pperegister" class="pperegister" active-class="active">
          <span>Register new PPE</span>
        </router-link>

        <router-link to="/dashboard/employees" class="menu-item" active-class="active">
          <img src="./assets/employeesIcon.png" alt="" width="35">
          <span>Employees</span>
        </router-link>

        <router-link to="/dashboard/issuance" class="menu-item" active-class="active">
          <img src="./assets/issuanceIcon.png" alt="" width="35">
          <span>Issuance</span>
        </router-link>

        <router-link to="/dashboard/inventory" class="menu-item" active-class="active">
          <img src="./assets/inventoryIcon.png" alt="" width="35">
          <span>Inventory</span>
        </router-link>
